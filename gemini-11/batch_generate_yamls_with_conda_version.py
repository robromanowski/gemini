...
if __name__ == "__main__":
    ...
    if found_envs_data:
        ...
        for env_path, last_modified in found_envs_data:
            try:
                result_dict = process_environment(env_path, output_dir_history_ok, output_dir_fallback, archive_dir_history, archive_dir_list, str(conda_exe_path), args.use_shell, args.use_original_name)
                # Add last modified date to the result
